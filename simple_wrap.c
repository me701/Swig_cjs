...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__simple

#else
#  define SWIG_init    init_simple

#endif
#define SWIG_name    "_simple"
...
SWIGINTERN PyObject *_wrap_dot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  result = (double)dot(arg1,arg2,arg3,arg4);
...
SWIGINTERN PyObject *_wrap_arange(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  double *arg2 = (double *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:arange",&obj0)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
...
SWIGINTERN PyObject *_wrap_heat_transfer(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:heat_transfer",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "heat_transfer" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  result = (int)heat_transfer(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"arange", _wrap_arange, METH_VARARGS, NULL},
	 { (char *)"heat_transfer", _wrap_heat_transfer, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
